    ...
    <>
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div className="w-full">
                ...
                />
                {formik.errors.first ? (
                  <div className="text-red-600">{formik.errors.first}</div>
                ) : null}
              </div>
              <div className="w-full">
                <TextField
                ...
                />
                {formik.errors.last ? (
                  <div className="text-red-600">{formik.errors.last}</div>
                ) : null}
              </div>
            </div>
          </div>
      ...
      <div className="w-full h-56 bg-gray-100 flex items-center   md:text-center  ">
        <div className="lg:ml-40 m-5 md:text-center  ">
          <p>
            Got a question about your order? Need help with some of your app
            features? Contact Help Centre via app menu.
          </p>
        </div>
      </div>
    </>
